    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>checkoutn</span></li>
            </ul>
        </div>
         ...
         <form wire:submit.prevent='placeOrder'>
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                <input  type="text" name="province" value="" placeholder="United States" wire:model="province">
                            </p>
                            <p class="row-in-form">
                ...
                <div class="col-md-12">
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                <label for="add">line2</label>
                                <input  type="text" name="add2" value="" placeholder="Street at apartment number" wire:model="s_line2">
                            </p>
                            <p class="row-in-form">
                                <label for="country">Country<span>*</span></label>
            ...
            <div class="summary summary-checkout">
                <div class="summary-item payment-method">
                    ...
                    @if($paymentmode == 'card')
                    <div class="wrap-address-billing">
                        @if(Session::has('error_stripe'))
                            <div class="alert alert-success">
                                {{Session::get('error_stripe')}}
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="text" name="expiry-month" value="" placeholder="expiry month" wire:model="exp_month">
                        </p>
                        <p class="row-in-form">
                            <label for="expiry-year">Expiry Year:</label>
                            <input  type="text" name="expiry-year" value="" placeholder="expiry year" wire:model="exp_year">
                        </p>
                        <p class="row-in-form">
