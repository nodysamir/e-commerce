...
<body class="home-page home-01 ">
                                ...
                                @if(Route::has('login'))
                                    @auth
                                        @if(Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent" >
                                                <a title="Myaccount" href="#">Myaccount ({{ Auth::user()->name }})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
                                            <li class="menu-item" >
                                            ...
                                            <li class="menu-item" >
                                                <a title="Categories" href="{{ Route('admin.homeslider') }}">All Sliders</a>
                                            </li>
                                            ...
                                            <li class="menu-item" >
                                                <a title="change password" href="{{ Route('admin.sale') }}">Sale Setting</a>
                                            ...
                                            <li class="menu-item menu-item-has-children parent" >
                                                ...
                                                <ul class="submenu curency" >
                                                    <li class="menu-item" >
                                                     ...
                                                     <li class="menu-item" >
                                                        <a title="change password" href="{{ Route('user.changepassword') }}">Cange Password</a>
 ...
 {{$slot}}
    ...
    <script src="https://cdn.tiny.cloud/1/3ku40vhs6bxcf7keefngqke09u2pdkiiqa6xk1x78nems2st/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
    @livewireScripts
    @stack('scripts')
</body>
</html>
